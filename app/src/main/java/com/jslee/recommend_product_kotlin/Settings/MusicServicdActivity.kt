package com.jslee.recommend_product_kotlin.Settings
...
import com.jslee.recommend_product_kotlin.R
import kotlinx.android.synthetic.main.activity_setting.*
import java.io.BufferedReader
import java.io.InputStreamReader

class MusicServicdActivity : AppCompatActivity() {
    ...
    **/
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /** 'raw 파일로 저장 된 가사 보기' 버튼 클릭 */
        music_lrics_btn.setOnClickListener {

            val inputStream = resources.openRawResource(R.raw.text_raw_data)
            ...
            music_lrics_textView.text = sb.toString()
        }
